...
#        fileName = cms.string("TT_PU20bx25_v2.root")
#        fileName = cms.string("TT_S14_PU40bx50.root")
#                                   fileName = cms.string('TTJets_MG_PU20bx25_POSTLS170.root')
#        fileName = cms.string("wjets_PU20bx25.root")
#        fileName = cms.string("w1234jets_v5_v1.root")
#        fileName = cms.string("w1234jets_v5_v2.root") 
#        fileName = cms.string("DY_PU20bx25.root")
#        fileName = cms.string("QCD_80_120_MuEnriched_PU20bx25.root")
#        fileName = cms.string("QCD_120_170_MuEnriched_PU20bx25.root")
#        fileName = cms.string("QCD_170_300_MuEnriched_PU20bx25.root")
#        fileName = cms.string("QCD_300_470_MuEnriched_PU20bx25.root")
#        fileName = cms.string("QCD_470_600_MuEnriched_PU20bx25.root")
#        fileName = cms.string("QCD_600_800_MuEnriched_PU20bx25.root")
#        fileName = cms.string("QCD_800_1000_MuEnriched_PU20bx25.root")
#        fileName = cms.string("QCD_1000_MuEnriched_PU20bx25.root")
